...
// node_modules/@progress/kendo-angular-intl/fesm2020/progress-kendo-angular-intl.mjs
var packageMetadata = {
...
IntlService.ɵprov = ɵɵdefineInjectable({
  token: IntlService,
  factory: function IntlService_Factory2(t) {
    let r = null;
    if (t) {
      r = new t();
    } else {
...
var CldrIntlService = class extends IntlService {
  /**
...
CldrIntlService.ɵfac = function CldrIntlService_Factory(t) {
  return new (t || CldrIntlService)(ɵɵinject(LOCALE_ID));
};
CldrIntlService.ɵprov = ɵɵdefineInjectable({
...
DatePipe.ɵfac = function DatePipe_Factory(t) {
  return new (t || DatePipe)(ɵɵdirectiveInject(IntlService, 16));
};
...
NumberPipe.ɵfac = function NumberPipe_Factory(t) {
  return new (t || NumberPipe)(ɵɵdirectiveInject(IntlService, 16));
};
NumberPipe.ɵpipe = ɵɵdefinePipe({
  name: "kendoNumber",
  type: NumberPipe,
  pure: true
});
...
//# sourceMappingURL=chunk-ELXDII2W.js.map
