...
var IconsService = class {
  constructor(_iconSettings, iconSettingsService) {
    ...
    this.changes = new import_rxjs.BehaviorSubject(this.iconSettings || {
      type: "svg"
    });
    this.subs = new import_rxjs.Subscription();
    if (iconSettingsService) {
      this.subs.add(iconSettingsService.changes.pipe((0, import_operators.map)((iconSettings) => isPresent(iconSettings) ? iconSettings : this._iconSettings), (0, import_operators.tap)((iconSettings) => this._iconSettings = iconSettings)).subscribe((iconSettings) => this.changes.next(iconSettings)));
    }
  }
  /**
   * @hidden
...
//# sourceMappingURL=chunk-2GY5W5UB.js.map
