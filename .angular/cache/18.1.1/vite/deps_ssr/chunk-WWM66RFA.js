...
// node_modules/@progress/kendo-angular-layout/fesm2015/progress-kendo-angular-layout.mjs
var import_rxjs2 = __toESM(require_cjs(), 1);
var import_operators2 = __toESM(require_operators(), 1);

// node_modules/@progress/kendo-angular-progressbar/fesm2015/progress-kendo-angular-progressbar.mjs
...
ProgressBarComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    ...
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_PROGRESSBAR_FESM2015_PROGRESS_KENDO_ANGULAR_PROGRESSBAR_MJS_0 = goog.getMsg("Progressbar");
      i18n_0 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_PROGRESSBAR_FESM2015_PROGRESS_KENDO_ANGULAR_PROGRESSBAR_MJS_0;
    } else {
...
ChunkProgressBarComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    let i18n_1;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_PROGRESSBAR_FESM2015_PROGRESS_KENDO_ANGULAR_PROGRESSBAR_MJS_1 = goog.getMsg("Chunk progressbar");
      i18n_1 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_PROGRESSBAR_FESM2015_PROGRESS_KENDO_ANGULAR_PROGRESSBAR_MJS_1;
    } else {
...
CircularProgressBarComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    let i18n_2;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_PROGRESSBAR_FESM2015_PROGRESS_KENDO_ANGULAR_PROGRESSBAR_MJS_2 = goog.getMsg("Circular progressbar");
      i18n_2 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_PROGRESSBAR_FESM2015_PROGRESS_KENDO_ANGULAR_PROGRESSBAR_MJS_2;
    } else {
...
var _c13 = ["kendoTabStripScrollableButton", ""];
var _c14 = ["tablist"];
...
var PanelBarService = class {
  constructor() {
    this.parentSource = new import_rxjs2.Subject();
    this.keepContentSource = new import_rxjs2.BehaviorSubject(false);
    this.childSource = new import_rxjs2.Subject();
    this.itemClick = new import_rxjs2.Subject();
...
var preventOnDblClick = (release) => (mouseDown) => (0, import_rxjs2.of)(mouseDown).pipe((0, import_operators2.delay)(150), (0, import_operators2.takeUntil)(release));
var classFromObject = (classes) => Object.keys(classes).filter((c) => classes[c]).join(" ");
var createMoveStream = (draggable) => (mouseDown) => draggable.kendoDrag.pipe((0, import_operators2.takeUntil)(draggable.kendoRelease), (0, import_operators2.map)(({
  pageX,
  pageY
}) => ({
...
var SplitterBarComponent = class {
  ...
  ngOnInit() {
    let state2;
    const listener = this.draggable.kendoPress.pipe((0, import_operators2.tap)(stopPropagation), (0, import_operators2.filter)(() => this.splitterService.isDraggable(this.index)), (0, import_operators2.tap)(() => state2 = this.splitterService.dragState(this.index)), (0, import_operators2.tap)(() => this.splitterService.toggleContentOverlay(this.index, true)), (0, import_operators2.switchMap)(preventOnDblClick(this.draggable.kendoRelease)), (0, import_operators2.switchMap)(createMoveStream(this.draggable))).subscribe(({
      pageX,
      pageY,
      originalX,
      originalY
...
var ScrollService = class {
  constructor(ngZone) {
    this.ngZone = ngZone;
    this.position = 0;
    this.scrollButtonActiveStateChange = new import_rxjs2.Subject();
...
TabStripComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    let i18n_0;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2015_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_0 = goog.getMsg("Close");
      i18n_0 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2015_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_0;
    } else {
      i18n_0 = $localize`:kendo.tabstrip.closeTitle|The title for the **Close** button in the TabStrip tab.:Close`;
    }
    let i18n_1;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2015_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_1 = goog.getMsg("Previous Tab");
      i18n_1 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2015_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_1;
    } else {
    ...
    let i18n_2;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2015_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_2 = goog.getMsg("Next Tab");
      i18n_2 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2015_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_2;
    } else {
...
var DrawerComponent = class {
  ...
  toggle(expanded) {
    ...
    if (this.animation) {
      this.animationEnd.pipe((0, import_operators2.take)(1)).subscribe(() => {
...
StepperComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    let i18n_3;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2015_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_3 = goog.getMsg("Optional");
      i18n_3 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2015_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_3;
    } else {
...
AvatarComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    let i18n_4;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2015_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_4 = goog.getMsg("Avatar");
      i18n_4 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2015_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_4;
    } else {
...
var TileLayoutDraggingService = class {
  constructor(zone, renderer, cdr, localization) {
    ...
    this.cdr = cdr;
    this.localization = localization;
    this.reorderable = new import_rxjs2.BehaviorSubject(null);
    this.resizable = new import_rxjs2.BehaviorSubject(null);
    this.reorder = new import_rxjs2.Subject();
    this.resize = new import_rxjs2.Subject();
...
var TileLayoutKeyboardNavigationService = class {
  constructor(zone, renderer, localization) {
    ...
    this.renderer = renderer;
    this.localization = localization;
    this.navigable = new import_rxjs2.BehaviorSubject(false);
    this.localizationSubscription = this.localization.changes.subscribe(({
      rtl
    }) => this.rtl = rtl);
  }
...
var TileLayoutItemComponent = class {
  ...
  ngAfterViewInit() {
    ...
    this.subs.add(keyboardNavigation.navigable.subscribe((isNavigable) => {
      if (isNavigable) {
        this.keyboardNavigationSubs = new import_rxjs2.Subscription();
...
var TimelineHorizontalComponent = class {
  ...
  ngOnInit() {
    this._zone.runOutsideAngular(() => isDocumentAvailable() && this.subscriptions.add((0, import_rxjs2.fromEvent)(window, "resize").subscribe(this.handleWindowResize.bind(this))));
    this.l10nChange();
  ...
  get calloutOffset() {
    ...
    if (!((_a = this.circleElementRefs) === null || _a === void 0 ? void 0 : _a.first) || !this.trackElementRef || !isPresent(this.selectedEventIndex)) {
      return {};
    }
...
var TimelineComponent = class {
  ...
  initTemplates() {
    ...
    this.subscriptions.add((_d = this.cardHeaderTemplate) === null || _d === void 0 ? void 0 : _d.changes.subscribe(() => {
      var _a2;
      this.headerTemplate = ((_a2 = this.cardHeaderTemplate) === null || _a2 === void 0 ? void 0 : _a2.first) || null;
    }));
    this.subscriptions.add((_e = this.cardBodyTemplate) === null || _e === void 0 ? void 0 : _e.changes.subscribe(() => {
      var _a2;
      this.bodyTemplate = ((_a2 = this.cardBodyTemplate) === null || _a2 === void 0 ? void 0 : _a2.first) || null;
    }));
    this.subscriptions.add((_f = this.cardActionsTemplate) === null || _f === void 0 ? void 0 : _f.changes.subscribe(() => {
      var _a2;
      this.actionsTemplate = ((_a2 = this.cardActionsTemplate) === null || _a2 === void 0 ? void 0 : _a2.first) || null;
    }));
  }
};
...
TimelineComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    let i18n_5;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2015_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_5 = goog.getMsg("previous");
      i18n_5 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2015_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_5;
    } else {
      i18n_5 = $localize`:kendo.timeline.previous|The title of the previous button in horizontal orientation.:previous`;
    }
    let i18n_6;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2015_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_6 = goog.getMsg("next");
      i18n_6 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2015_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_6;
    } else {
...
//# sourceMappingURL=chunk-WWM66RFA.js.map
