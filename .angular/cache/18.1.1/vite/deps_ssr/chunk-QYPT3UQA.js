...
// node_modules/@progress/kendo-angular-dateinputs/fesm2015/progress-kendo-angular-dateinputs.mjs
...
function handleRangeSelection(date, selectionRange, activeRangeEnd, allowReverse = false) {
  var _a2, _b, _c, _d, _e;
  if (activeRangeEnd === "start" && ((_a2 = selectionRange.start) === null || _a2 === void 0 ? void 0 : _a2.getTime()) === (date === null || date === void 0 ? void 0 : date.getTime()) && (allowReverse && !selectionRange.end || !allowReverse) || activeRangeEnd === "end" && ((_b = selectionRange.end) === null || _b === void 0 ? void 0 : _b.getTime()) === (date === null || date === void 0 ? void 0 : date.getTime())) {
    return {
      activeRangeEnd,
      selectionRange
    };
  ...
  */
  ...
  ngDoCheck() {
    ...
    if (this.valueSetter || this.selectionSetter) {
      if (this.selection === "range" && (((_a2 = this.value) === null || _a2 === void 0 ? void 0 : _a2.start) || ((_b = this.value) === null || _b === void 0 ? void 0 : _b.end)) && this.focusedDate.getTime() !== ((_c = this.value.start) === null || _c === void 0 ? void 0 : _c.getTime()) && this.focusedDate.getTime() !== ((_d = this.value.end) === null || _d === void 0 ? void 0 : _d.getTime())) {
  ...
  handleWeekNumberClick(dates) {
    ...
    this.zone.run(() => {
      ...
      if (this.selection === "range") {
        ...
        const shouldEmitValueChange = ((_a2 = this.selectionRange.start) === null || _a2 === void 0 ? void 0 : _a2.getTime()) !== dates[0].getTime() || ((_b = this.selectionRange.end) === null || _b === void 0 ? void 0 : _b.getTime()) !== last(dates).getTime();
  ...
  setValue(candidate) {
    ...
    if (candidate === null) {
      ...
      if (((_a2 = this._value) === null || _a2 === void 0 ? void 0 : _a2.start) && !((_b = this._value) === null || _b === void 0 ? void 0 : _b.end)) {
  ...
  performRangeSelection(date) {
    ...
    const emitValueChange = this.activeRangeEnd === "start" && ((_b = (_a2 = this.value) === null || _a2 === void 0 ? void 0 : _a2.start) === null || _b === void 0 ? void 0 : _b.getTime()) !== (date === null || date === void 0 ? void 0 : date.getTime()) || this.activeRangeEnd === "end" && ((_d = (_c = this.value) === null || _c === void 0 ? void 0 : _c.end) === null || _d === void 0 ? void 0 : _d.getTime()) !== (date === null || date === void 0 ? void 0 : date.getTime());
    this.zone.run(() => {
      var _a3, _b2, _c36, _d2, _e, _f, _g, _h, _j;
      ...
      if (this.canHover && rangeSelection.activeRangeEnd === "end" && ((_a3 = rangeSelection.selectionRange.end) === null || _a3 === void 0 ? void 0 : _a3.getTime()) === date.getTime()) {
        this.activeRangeEnd = "start";
      ...
      if (emitValueChange && (((_c36 = (_b2 = this.value) === null || _b2 === void 0 ? void 0 : _b2.start) === null || _c36 === void 0 ? void 0 : _c36.getTime()) !== ((_e = (_d2 = rangeSelection.selectionRange) === null || _d2 === void 0 ? void 0 : _d2.start) === null || _e === void 0 ? void 0 : _e.getTime()) || ((_g = (_f = this.value) === null || _f === void 0 ? void 0 : _f.end) === null || _g === void 0 ? void 0 : _g.getTime()) !== ((_j = (_h = rangeSelection.selectionRange) === null || _h === void 0 ? void 0 : _h.end) === null || _j === void 0 ? void 0 : _j.getTime()))) {
...
MultiViewCalendarComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    ...
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_0 = goog.getMsg("Today");
      i18n_0 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_0;
    } else {
      i18n_0 = $localize`:kendo.multiviewcalendar.today|The label for the today button in the calendar header:Today`;
    }
    let i18n_1;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_1 = goog.getMsg("Navigate to previous view");
      i18n_1 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_1;
    } else {
    ...
    let i18n_2;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_2 = goog.getMsg("Navigate to next view");
      i18n_2 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_2;
    } else {
    ...
    let i18n_3;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_3 = goog.getMsg("Navigate to parent view");
      i18n_3 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_3;
    } else {
...
var ScrollerService = class {
  ...
  create(rowHeightService, skip, take, total, topOffset = 0, bottomOffset = 0, direction = "vertical") {
    ...
    const subject = new import_rxjs.ReplaySubject(2);
    ...
    this.subscription = new import_rxjs.Observable((observer) => {
      this.unsubscribe();
...
var VirtualizationComponent = class {
  constructor(scrollerFactory, container, renderer, zone, scrollBarWidthService) {
    ...
    this.dispatcher = new import_rxjs.Subject();
  ...
  ngAfterViewInit() {
    this.zone.runOutsideAngular(() => {
      this.containerScrollSubscription = this.scroll$().pipe((0, import_operators.map)((event2) => event2.target)).subscribe((t) => {
  ...
  animateToIndex(index) {
    ...
    this.zone.runOutsideAngular(() => {
      this.animationSubscription = (0, import_rxjs.combineLatest)((0, import_rxjs.of)(start), (0, import_rxjs.interval)(0, import_rxjs.animationFrameScheduler)).pipe((0, import_operators.map)((stream) => stream[0]), (0, import_operators.scan)(modifyScroll), (0, import_operators.takeWhile)(isScrollValid), (0, import_operators.map)(normalizeScroll)).subscribe((x) => this.scrollTo(x));
    });
  }
  ...
  scroll$() {
    return isDocumentAvailable() ? (0, import_rxjs.fromEvent)(this.container.nativeElement, "scroll") : import_rxjs.EMPTY;
  }
  initServices() {
    this.rowHeightService = this.createRowHeightService();
    if (this.scrollSubscription) {
...
var ViewListComponent = class {
  ...
  get headerTitle() {
    var _a2;
    return (_a2 = this.headerComponent) === null || _a2 === void 0 ? void 0 : _a2.title;
  }
  get getComponentMonthClass() {
    return this.activeView === CalendarViewEnum.month;
  }
...
var CalendarComponent = class {
  ...
  focus() {
    var _a2, _b, _c;
    this.currentlyFocusedElement = this.type === "infinite" ? (_a2 = this.element) === null || _a2 === void 0 ? void 0 : _a2.nativeElement.querySelector(selectors.infiniteCalendarTable) : this.currentlyFocusedElement = (_b = this.element) === null || _b === void 0 ? void 0 : _b.nativeElement.querySelector(selectors.multiViewCalendarTable);
  ...
  onPageChange() {
    if (!NgZone.isInAngularZone()) {
      ...
      this.pageChangeSubscription = (0, import_rxjs.from)(this.resolvedPromise).subscribe(() => {
        this.detectChanges();
      });
    }
  }
  ...
  setAriaActivedescendant() {
    var _a2;
    const infiniteCalendarTable = (_a2 = this.element.nativeElement) === null || _a2 === void 0 ? void 0 : _a2.querySelector(selectors.infiniteCalendarTable);
...
CalendarComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    let i18n_4;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_4 = goog.getMsg("Today");
      i18n_4 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_4;
    } else {
      i18n_4 = $localize`:kendo.calendar.today|The label for the today button in the calendar header:Today`;
    }
    let i18n_5;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_5 = goog.getMsg("Navigate to previous view");
      i18n_5 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_5;
    } else {
    ...
    let i18n_6;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_6 = goog.getMsg("Navigate to next view");
      i18n_6 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_6;
    } else {
    ...
    let i18n_7;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_7 = goog.getMsg("Navigate to parent view");
      i18n_7 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_7;
    } else {
...
var DateInputComponent = class {
  ...
  ngOnChanges(changes) {
    ...
    if (changes["format"] || changes["placeholder"]) {
      ...
      (_a2 = this.kendoDate) === null || _a2 === void 0 ? void 0 : _a2.setOptions(this.options, true);
      this.updateFormatSections();
    }
  ...
  ngAfterViewInit() {
    ...
    const formControl = (_a2 = this.injector.get(NgControl, null)) === null || _a2 === void 0 ? void 0 : _a2.control;
  ...
  initKendoDate() {
    const kendoDate = new DateInput(this.dateInput.nativeElement, Object.assign(Object.assign({}, this.options), {
      events: {
...
DateInputComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    let i18n_8;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_8 = goog.getMsg("Increase value");
      i18n_8 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_8;
    } else {
      i18n_8 = $localize`:kendo.dateinput.increment|The label for the **Increment** button in the DateInput:Increase value`;
    }
    let i18n_9;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_9 = goog.getMsg("Decrease value");
      i18n_9 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_9;
    } else {
      i18n_9 = $localize`:kendo.dateinput.decrement|The label for the **Decrement** button in the DateInput:Decrease value`;
    }
    let i18n_10;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_10 = goog.getMsg("clear");
      i18n_10 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_10;
    } else {
...
var DatePickerComponent = class extends MultiTabStop {
  ...
  get popupUID() {
    var _a2;
    return (_a2 = this.calendar) === null || _a2 === void 0 ? void 0 : _a2.popupId;
  }
  get isActive() {
    return this._active;
  }
  ...
  ngOnInit() {
    ...
    this.focusableId = (_a2 = this.dateInput) === null || _a2 === void 0 ? void 0 : _a2.focusableId;
  }
  ngAfterViewInit() {
    this.setComponentClasses();
  ...
  togglePopup(show) {
    ...
    if (show) {
      ...
      this.renderer.setAttribute((_a2 = this.dateInput) === null || _a2 === void 0 ? void 0 : _a2.inputElement, attributeNames.ariaControls, this.popupUID);
  ...
  setAriaActiveDescendant() {
    ...
    this.ariaActiveDescendantSubscription = focusedCellChangeEvent.subscribe((id) => {
      var _a2;
      return this.renderer.setAttribute((_a2 = this.dateInput) === null || _a2 === void 0 ? void 0 : _a2.inputElement, attributeNames.ariaActiveDescendant, id);
    });
  }
  focusInput() {
  ...
  bindEvents() {
    ...
    if (isWindowAvailable()) {
      this.windowBlurSubscription = (0, import_rxjs.fromEvent)(window, "blur").subscribe(this.handleWindowBlur.bind(this));
    }
  }
  handleFocus() {
    if (this.isActive) {
...
DatePickerComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    let i18n_11;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_11 = goog.getMsg("Today");
      i18n_11 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_11;
    } else {
      i18n_11 = $localize`:kendo.datepicker.today|The label for the today button in the calendar header:Today`;
    }
    let i18n_12;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_12 = goog.getMsg("Toggle calendar");
      i18n_12 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_12;
    } else {
      i18n_12 = $localize`:kendo.datepicker.toggle|The title of the toggle button in the datepicker component:Toggle calendar`;
    }
    let i18n_13;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_13 = goog.getMsg("Navigate to previous view");
      i18n_13 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_13;
    } else {
    ...
    let i18n_14;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_14 = goog.getMsg("Navigate to next view");
      i18n_14 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_14;
    } else {
    ...
    let i18n_15;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_15 = goog.getMsg("Navigate to parent view");
      i18n_15 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_15;
    } else {
    ...
    let i18n_16;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_16 = goog.getMsg("clear");
      i18n_16 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_16;
    } else {
...
var TimeListComponent = class {
  ...
  get ariaLabel() {
    var _a2;
    return this.localization.get((_a2 = this.part) === null || _a2 === void 0 ? void 0 : _a2.type);
  }
  get tabIndex() {
  ...
  get isDayPeriod() {
    var _a2;
    return ((_a2 = this.part) === null || _a2 === void 0 ? void 0 : _a2.type) === "dayperiod";
  }
  ...
  bindEvents() {
    this.scrollSubscription = this.virtualization.scroll$().pipe((0, import_operators.debounceTime)(100), (0, import_operators.map)((e) => e.target.scrollTop), (0, import_operators.map)((top) => this.itemOffset(top)), (0, import_operators.map)((itemOffset) => this.virtualization.itemIndex(itemOffset))).subscribe((index) => {
...
var TimeSelectorComponent = class {
  ...
  ngAfterViewInit() {
    this.subscriptions.add((0, import_rxjs.fromEvent)(this.timeListWrappers.first.nativeElement, "keydown").subscribe((event2) => {
      const {
        keyCode,
        shiftKey
      } = event2;
    ...
    this.subscriptions.add((0, import_rxjs.fromEvent)(this.timeListWrappers.last.nativeElement, "keydown").subscribe((event2) => {
      const {
        keyCode,
        shiftKey
      } = event2;
  ...
  handleTabOut(event2) {
    ...
    if (event2.target === ((_a2 = this.now) === null || _a2 === void 0 ? void 0 : _a2.nativeElement) && keyCode === Keys.Tab && shiftKey) {
      event2.preventDefault();
    ...
    if (keyCode === Keys.Tab && !shiftKey && event2.target !== ((_b = this.now) === null || _b === void 0 ? void 0 : _b.nativeElement)) {
      event2.preventDefault();
...
TimeSelectorComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    let i18n_17;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_17 = goog.getMsg("Set");
      i18n_17 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_17;
    } else {
      i18n_17 = $localize`:kendo.timeselector.accept|The Accept button text in the timeselector component:Set`;
    }
    let i18n_18;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_18 = goog.getMsg("Set time");
      i18n_18 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_18;
    } else {
      i18n_18 = $localize`:kendo.timeselector.acceptLabel|The label for the Accept button in the timeselector component:Set time`;
    }
    let i18n_19;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_19 = goog.getMsg("Cancel");
      i18n_19 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_19;
    } else {
      i18n_19 = $localize`:kendo.timeselector.cancel|The Cancel button text in the timeselector component:Cancel`;
    }
    let i18n_20;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_20 = goog.getMsg("Cancel changes");
      i18n_20 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_20;
    } else {
    ...
    let i18n_21;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_21 = goog.getMsg("Now");
      i18n_21 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_21;
    } else {
      i18n_21 = $localize`:kendo.timeselector.now|The Now button text in the timeselector component:Now`;
    }
    let i18n_22;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_22 = goog.getMsg("Select now");
      i18n_22 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_22;
    } else {
...
TimePickerComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    let i18n_23;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_23 = goog.getMsg("Set");
      i18n_23 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_23;
    } else {
      i18n_23 = $localize`:kendo.timepicker.accept|The Accept button text in the timepicker component:Set`;
    }
    let i18n_24;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_24 = goog.getMsg("Set time");
      i18n_24 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_24;
    } else {
      i18n_24 = $localize`:kendo.timepicker.acceptLabel|The label for the Accept button in the timepicker component:Set time`;
    }
    let i18n_25;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_25 = goog.getMsg("Cancel");
      i18n_25 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_25;
    } else {
      i18n_25 = $localize`:kendo.timepicker.cancel|The Cancel button text in the timepicker component:Cancel`;
    }
    let i18n_26;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_26 = goog.getMsg("Cancel changes");
      i18n_26 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_26;
    } else {
      i18n_26 = $localize`:kendo.timepicker.cancelLabel|The label for the Cancel button in the timepicker component:Cancel changes`;
    }
    let i18n_27;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_27 = goog.getMsg("Now");
      i18n_27 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_27;
    } else {
      i18n_27 = $localize`:kendo.timepicker.now|The Now button text in the timepicker component:Now`;
    }
    let i18n_28;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_28 = goog.getMsg("Select now");
      i18n_28 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_28;
    } else {
      i18n_28 = $localize`:kendo.timepicker.nowLabel|The label for the Now button in the timepicker component:Select now`;
    }
    let i18n_29;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_29 = goog.getMsg("Toggle time list");
      i18n_29 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_29;
    } else {
      i18n_29 = $localize`:kendo.timepicker.toggle|The label for the toggle button in the timepicker component:Toggle time list`;
    }
    let i18n_30;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_30 = goog.getMsg("Hour");
      i18n_30 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_30;
    } else {
      i18n_30 = $localize`:kendo.timepicker.hour|The label for the hour part in the timepicker component:Hour`;
    }
    let i18n_31;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_31 = goog.getMsg("Minute");
      i18n_31 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_31;
    } else {
      i18n_31 = $localize`:kendo.timepicker.minute|The label for the minute part in the timepicker component:Minute`;
    }
    let i18n_32;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_32 = goog.getMsg("Second");
      i18n_32 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_32;
    } else {
      i18n_32 = $localize`:kendo.timepicker.second|The label for the second part in the timepicker component:Second`;
    }
    let i18n_33;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_33 = goog.getMsg("Millisecond");
      i18n_33 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_33;
    } else {
      i18n_33 = $localize`:kendo.timepicker.millisecond|The label for the millisecond part in the timepicker component:Millisecond`;
    }
    let i18n_34;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_34 = goog.getMsg("Dayperiod");
      i18n_34 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_34;
    } else {
      i18n_34 = $localize`:kendo.timepicker.dayperiod|The label for the dayperiod part in the timepicker component:Dayperiod`;
    }
    let i18n_35;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_35 = goog.getMsg("clear");
      i18n_35 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_35;
    } else {
...
var DateTimePickerComponent = class extends MultiTabStop {
  ...
  get isOpen() {
    ...
    return isTruthy((_a2 = this.actionSheet) === null || _a2 === void 0 ? void 0 : _a2.expanded);
  }
  /**
  ...
  get acceptButton() {
    ...
    if (this.isAdaptive) {
      ...
      return (_a2 = this.popupRef) === null || _a2 === void 0 ? void 0 : _a2.popup.instance.container.nativeElement.querySelector(ACCEPT_BUTTON_SELECTOR);
    }
  }
  get cancelButtonElement() {
    ...
    if (this.isAdaptive) {
      ...
      return (_a2 = this.popupRef) === null || _a2 === void 0 ? void 0 : _a2.popup.instance.container.nativeElement.querySelector(CANCEL_BUTTON_SELECOTR);
    }
  }
  get dateTabButton() {
    var _a2;
    return (_a2 = this.popupRef) === null || _a2 === void 0 ? void 0 : _a2.popup.instance.container.nativeElement.querySelector(DATE_TAB_BUTTON_SELECTOR);
  }
  get timeTabButton() {
    var _a2;
    return (_a2 = this.popupRef) === null || _a2 === void 0 ? void 0 : _a2.popup.instance.container.nativeElement.querySelector(TIME_TAB_BUTTON_SELECTOR);
  }
  /**
   * @hidden
   */
  ...
  ngOnInit() {
    var _a2;
    this.subscriptions.add(this.pickerService.onFocus.pipe((0, import_operators.tap)(this.detectPopupChanges.bind(this))).subscribe(this.handleFocus.bind(this)));
    ...
    if (isWindowAvailable()) {
      this.subscriptions.add(this.ngZone.runOutsideAngular(() => (0, import_rxjs.fromEvent)(window, "blur").subscribe(() => {
        if (!this.isAdaptive) {
          this.handleCancel();
        }
      })));
  ...
  handleTabChangeTransitionEnd(dateTimeSelector, event2) {
    ...
    if (this.activeTab === "time") {
      this.renderer.removeAttribute((_a2 = this.dateInput) === null || _a2 === void 0 ? void 0 : _a2.inputElement, attributeNames.ariaActiveDescendant);
    }
    this.activeTabComponent.focus();
  }
  /**
  ...
  openPopup() {
    ...
    if (this.calendar.type === "infinite") {
      this.subscriptions.add((0, import_rxjs.fromEvent)(this.calendar.monthView.list.nativeElement, "keydown").subscribe((event2) => {
        const {
          keyCode,
          shiftKey
        } = event2;
  ...
  closePopup() {
    ...
    this.ariaActiveDescendantSubscription.unsubscribe();
    if (this.dateInput) {
      this.renderer.removeAttribute((_a2 = this.dateInput) === null || _a2 === void 0 ? void 0 : _a2.inputElement, attributeNames.ariaControls);
...
DateTimePickerComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    let i18n_36;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_36 = goog.getMsg("Date");
      i18n_36 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_36;
    } else {
      i18n_36 = $localize`:kendo.datetimepicker.dateTab|The Date tab text in the datetimepicker popup header:Date`;
    }
    let i18n_37;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_37 = goog.getMsg("Date tab");
      i18n_37 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_37;
    } else {
    ...
    let i18n_38;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_38 = goog.getMsg("Time");
      i18n_38 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_38;
    } else {
      i18n_38 = $localize`:kendo.datetimepicker.timeTab|The Time tab text in the datetimepicker popup header:Time`;
    }
    let i18n_39;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_39 = goog.getMsg("Time tab");
      i18n_39 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_39;
    } else {
    ...
    let i18n_40;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_40 = goog.getMsg("Toggle popup");
      i18n_40 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_40;
    } else {
      i18n_40 = $localize`:kendo.datetimepicker.toggle|The title of the toggle button in the datetimepicker component:Toggle popup`;
    }
    let i18n_41;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_41 = goog.getMsg("Set");
      i18n_41 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_41;
    } else {
      i18n_41 = $localize`:kendo.datetimepicker.accept|The Accept button text in the datetimepicker component:Set`;
    }
    let i18n_42;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_42 = goog.getMsg("Set");
      i18n_42 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_42;
    } else {
      i18n_42 = $localize`:kendo.datetimepicker.acceptLabel|The label for the Accept button in the datetimepicker component:Set`;
    }
    let i18n_43;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_43 = goog.getMsg("Cancel");
      i18n_43 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_43;
    } else {
      i18n_43 = $localize`:kendo.datetimepicker.cancel|The Cancel button text in the datetimepicker component:Cancel`;
    }
    let i18n_44;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_44 = goog.getMsg("Cancel");
      i18n_44 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_44;
    } else {
      i18n_44 = $localize`:kendo.datetimepicker.cancelLabel|The label for the Cancel button in the datetimepicker component:Cancel`;
    }
    let i18n_45;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_45 = goog.getMsg("NOW");
      i18n_45 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_45;
    } else {
      i18n_45 = $localize`:kendo.datetimepicker.now|The Now button text in the timepicker component:NOW`;
    }
    let i18n_46;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_46 = goog.getMsg("Select now");
      i18n_46 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_46;
    } else {
      i18n_46 = $localize`:kendo.datetimepicker.nowLabel|The label for the Now button in the timepicker component:Select now`;
    }
    let i18n_47;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_47 = goog.getMsg("Today");
      i18n_47 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_47;
    } else {
      i18n_47 = $localize`:kendo.datetimepicker.today|The label for the today button in the calendar header:Today`;
    }
    let i18n_48;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_48 = goog.getMsg("Navigate to previous view");
      i18n_48 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_48;
    } else {
    ...
    let i18n_49;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_49 = goog.getMsg("Navigate to next view");
      i18n_49 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_49;
    } else {
    ...
    let i18n_50;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_50 = goog.getMsg("Navigate to parent view");
      i18n_50 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_50;
    } else {
    ...
    let i18n_51;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_51 = goog.getMsg("Hour");
      i18n_51 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_51;
    } else {
      i18n_51 = $localize`:kendo.datetimepicker.hour|The label for the hour part in the timepicker component:Hour`;
    }
    let i18n_52;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_52 = goog.getMsg("Minute");
      i18n_52 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_52;
    } else {
      i18n_52 = $localize`:kendo.datetimepicker.minute|The label for the minute part in the timepicker component:Minute`;
    }
    let i18n_53;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_53 = goog.getMsg("Second");
      i18n_53 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_53;
    } else {
      i18n_53 = $localize`:kendo.datetimepicker.second|The label for the second part in the timepicker component:Second`;
    }
    let i18n_54;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_54 = goog.getMsg("Millisecond");
      i18n_54 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_54;
    } else {
    ...
    let i18n_55;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_55 = goog.getMsg("Dayperiod");
      i18n_55 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_55;
    } else {
      i18n_55 = $localize`:kendo.datetimepicker.dayperiod|The label for the dayperiod part in the timepicker component:Dayperiod`;
    }
    let i18n_56;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_56 = goog.getMsg("clear");
      i18n_56 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_56;
    } else {
...
var DateRangeService = class {
  ...
  constructor(renderer) {
    this.renderer = renderer;
    this.activeRangeEnd$ = new import_rxjs.BehaviorSubject(null);
    this.focusedDate$ = new import_rxjs.BehaviorSubject(null);
    this.endInput$ = new import_rxjs.BehaviorSubject(null);
    this.startInput$ = new import_rxjs.BehaviorSubject(null);
    this.dateRangePopup$ = new import_rxjs.BehaviorSubject(null);
    this.range$ = new import_rxjs.BehaviorSubject(EMPTY_SELECTIONRANGE);
  }
  /**
...
var DateRangeSelectionDirective = class {
  constructor(calendar, cdr, element, renderer, dateRangeService) {
    ...
    this.calendarSubscriptions = new import_rxjs.Subscription();
  ...
  ngOnInit() {
    ...
    this.addSubscriptions(calendar.cellEnter.subscribe((value) => this.handleHover(value)), calendar.valueChange.subscribe((value) => this.handleChange(value)), dateRangeService.focusedDate$.subscribe((focusedDate) => {
      ...
      this.updateFocusedDate(range2);
    }), (0, import_rxjs.fromEvent)(this.element.nativeElement, "blur").subscribe(() => this.handleBlur()));
  }
  ngOnDestroy() {
...
var DateRangePopupComponent = class {
  constructor(popupService, dateRangeService, zone, renderer, localization, cdr, rtl) {
    ...
    this.xIcon = xIcon;
    this.calendarSubscriptions = new import_rxjs.Subscription();
    this.popupSubscriptions = new import_rxjs.Subscription();
  ...
  ngAfterViewInit() {
    ...
    this.calendarSubscriptions.add(this.contentCalendar.changes.subscribe((changes) => {
      ...
      this.actionSheet.titleId = (_a3 = changes.first) === null || _a3 === void 0 ? void 0 : _a3.headerId;
      this.cdr.detectChanges();
    }));
    ...
    this.calendarSubscriptions.add((_b = (_a2 = this.dateRangeService.startInput$) === null || _a2 === void 0 ? void 0 : _a2.value) === null || _b === void 0 ? void 0 : _b.valueChange.subscribe((res) => {
    ...
    if (isWindowAvailable()) {
      this.zone.runOutsideAngular(() => this.windowBlurSubscription = (0, import_rxjs.fromEvent)(window, "blur").subscribe(this.handleWindowBlur.bind(this)));
    }
    if (this.actionSheet && isDocumentAvailable()) {
      this.actionSheet.element.nativeElement.style.setProperty("--kendo-actionsheet-height", "60vh");
      this.actionSheet.element.nativeElement.style.setProperty("--kendo-actionsheet-max-height", "none");
  ...
  activate() {
    ...
    this.cdr.markForCheck();
    this.zone.runOutsideAngular(() => {
      this.activateSubscription = (0, import_rxjs.merge)(this.contentCalendar.changes, this.viewCalendar.changes).pipe((0, import_operators.filter)((changes) => changes && changes.first), (0, import_operators.map)((changes) => changes.first)).subscribe((calendar) => setTimeout(() => {
        calendar.focus();
  ...
  subscribeFocusBlur(calendar) {
    ...
    this.blurSubscription = (0, import_rxjs.fromEvent)(calendarElement, "blur").subscribe(() => this.onBlur.emit());
    this.focusSubscription = (0, import_rxjs.fromEvent)(calendarElement, "focus").subscribe(() => this.onFocus.emit());
  }
  ...
  togglePopup(show) {
    ...
    if (this._show) {
      ...
      this.addPopupSubscriptions(this.zone.runOutsideAngular(() => (0, import_rxjs.fromEvent)(popupElement, "keydown").subscribe(this.handleKeydown.bind(this))), (0, import_rxjs.fromEvent)(popupElement, "mouseleave").subscribe(this.handleMouseLeave.bind(this)), popupAnchorViewportLeave.subscribe(() => this.cancelPopup()));
    }
  }
  destroyPopup() {
...
DateRangePopupComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    let i18n_57;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_57 = goog.getMsg("Set");
      i18n_57 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_57;
    } else {
      i18n_57 = $localize`:kendo.daterangepopup.accept|The Accept button text in the timepicker component:Set`;
    }
    let i18n_58;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_58 = goog.getMsg("Set time");
      i18n_58 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_58;
    } else {
      i18n_58 = $localize`:kendo.daterangepopup.acceptLabel|The label for the Accept button in the timepicker component:Set time`;
    }
    let i18n_59;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_59 = goog.getMsg("Cancel");
      i18n_59 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_59;
    } else {
      i18n_59 = $localize`:kendo.daterangepopup.cancel|The Cancel button text in the timepicker component:Cancel`;
    }
    let i18n_60;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_60 = goog.getMsg("Cancel changes");
      i18n_60 = MSG_C__ANGULAR_ARM_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2015_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_60;
    } else {
...
var DateRangeComponent = class {
  ...
  */
  ...
  ngOnDestroy() {
    var _a2;
    (_a2 = this.subscription) === null || _a2 === void 0 ? void 0 : _a2.unsubscribe();
  }
};
...
var DateRangeInput = class {
  ...
  init() {
    ...
    }), this.dateRangeService.dateRangePopup$.subscribe((popup) => this.initPopup(popup)), this.dateRangeService.range$.subscribe((range2) => this.updateInputValue(range2)), (0, import_rxjs.fromEvent)(this.element.nativeElement, "click").subscribe(() => this.activate()), (0, import_rxjs.fromEvent)(this.element.nativeElement, "keydown").subscribe((event2) => this.togglePopup(event2 || {}))].map((s) => this.subscriptions.add(s));
  }
  destroy() {
    this.subscriptions.unsubscribe();
...
//# sourceMappingURL=chunk-QYPT3UQA.js.map
